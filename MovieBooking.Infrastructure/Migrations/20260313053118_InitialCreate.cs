        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theatres_AspNetUsers_AdminUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScreenId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    TheatreId = table.Column<int>(type: "int", nullable: false),
                    ScreenName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeatId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    ScreenId = table.Column<int>(type: "int", nullable: false),
                    RowLabel = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvenienceFee = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    Status = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shows_Screen_Date_Time",
                table: "Shows",
                columns: new[] { "ScreenId", "ShowDate", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Theatres_AdminUserId",
                table: "Theatres",
                column: "AdminUserId");
